...
The application sends signup confirmations to `/verify-email` and password recovery links to `/reset-password`. Add the live application origin and these paths to **Authentication → URL Configuration → Redirect URLs** before testing production emails.
